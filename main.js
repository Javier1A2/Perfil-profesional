const translations = {
  es: {
    ...
    cvEsp: "CV Español",
    cvIng: "CV Inglés",
    bio1: "Soy estudiante de Ingeniería de Software en la Facultad de Telemática (Universidad de Colima). Me apasiona el desarrollo de software seguro, la creación de aplicaciones web y móviles y la innovación tecnológica aplicada a problemas reales.",
    bio2: "He trabajado en proyectos prácticos que van desde la configuración de una estación SatNOGS en Raspberry Pi hasta el desarrollo de aplicaciones con Expo (React Native) y soluciones web con enfoque en seguridad y usabilidad. Además, actualmente desarrollo una tesis sobre la brecha digital y su impacto en la inserción laboral de MiPyMEs en Colima.",
    proj1desc: "Aplicación web que permite a los usuarios participar en procesos de votación en línea de forma segura y con resultados en tiempo real visualizados con gráficos. Desarrollo en equipo, base de datos SQL y buen manejo de sesiones y validaciones.",
    gotoSite: "Ir al sitio",
    proj2desc: "Configuración completa de una Raspberry Pi para recibir y procesar datos de satélites, integrando sensores y scripts de automatización para la red colaborativa SatNOGS. Aprendizaje en radiofrecuencia, antenas y gestión de logs.",
    gotoDocs: "Documentación SatNOGS",
    proj3desc: "Investigación sobre la brecha digital y su impacto en la inserción laboral en MiPyMEs de Colima. Incluye marco teórico, encuestas locales, análisis estadístico y una propuesta de capacitación y digitalización para micro y pequeñas empresas.",
    inProgress: "En desarrollo",
    proj4desc: "Videojuego 2D para ESP32 con pantalla LCD, joystick y audio mediante I2S. Uso de doble núcleo: uno para lógica y otro para audio; optimizaciones en memoria y rendimiento.",
    proj5desc: "Ejercicio práctico de mejora de usabilidad y diseño para un sitio de noticias deportivas. Enfoque en responsive design, performance y accesibilidad.",
    proj6desc: "App multiplataforma (Android / iOS / Web) desarrollada con React Native + Expo, sistema de navegación y pruebas con Expo Go. Enfocada en desarrollo ágil y experiencia de usuario.",
    proj7desc: "Aplicación de escritorio desarrollada en Java con interfaz gráfica, que permite realizar operaciones matemáticas básicas.",
    seeMore: "¿Quieres ver más proyectos?",
    ctaDesc: "Puedo compartir repositorios adicionales, demos o presentaciones según lo requieras.",
    ...
    comm: "Comunicación efectiva",
    team: "Trabajo en equipo",
    critical: "Pensamiento crítico",
    solve: "Resolución de problemas",
    time: "Gestión del tiempo",
    adapt: "Adaptabilidad",
    resp: "Responsabilidad",
    learn: "Aprendizaje continuo",
    contactDesc: "Si quieres hablar de prácticas profesionales, colaboraciones o ver demos más extensos, escríbeme y con gusto coordinamos:",
    networks: "Redes",
    email: "Correo",
    available: "Disponible para prácticas, proyectos y colaboraciones locales (Colima) y remoto.",
  ...
  en: {
    ...
    proj7desc: "Desktop application developed in Java with a graphical interface, allowing basic mathematical operations.",
